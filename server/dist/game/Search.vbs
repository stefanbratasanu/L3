...
If path = "" Then
	MsgBox "Could not find JAVA_HOME environment variable!", vbOKOnly, "Search"
Else
...
'Generate command.
command = path & "java " & parameters & " -cp ./../libs/* org.l2jmobius.tools.Search"
If window = 1 Then
	command = "cmd /c start ""L2J Mobius - Search"" " & command
End If
